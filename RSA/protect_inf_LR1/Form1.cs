    ...
    public partial class Form1 : Form
    {
            ...
            if ((textBox_p.Text.Length > 0) && (textBox_q.Text.Length > 0))
            {
                ...
                if (IsTheNumberSimple(p) && IsTheNumberSimple(q))
                {
                   ...
                   StreamReader sr = new StreamReader("inputText.txt");
                    ...
                    long n = p * q;
                    long fi = (p - 1) * (q - 1);
                    long d = Calculate_d(fi);
                    long e_ = Calculate_e(d, fi);
                    ...
                    MessageBox.Show("Зашифрованно успешно. Результат в файле Crypt.text");
                    label4.Visible = true;
                    label5.Visible = true;
        ...
        private void buttonDecipher_Click(object sender, EventArgs e)
        {
            if ((textBox_d.Text.Length > 0) && (textBox_n.Text.Length > 0))
            {
                ...
                sw.WriteLine(result);
                sw.Close();
                MessageBox.Show("Расшифрованно успешно. Результат в файле Decrypt.text");
